...
def save_data_dash(dm):
    ...
    combolayout=[[sg.Combo(['CSV', 'XLSX', 'TXT'], default_value='PNG', readonly=True, key='-LB-')]]
    ...
    [sg.Text('Click "Save" to save the plot and "Exit" to quit the dataframe saving dashboard', size=(55,1))],
