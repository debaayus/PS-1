...
def save_plot_dashboard(fig):
    ...
    [sg.Text('Click "Save" to save the plot and "Exit" to quit the plot saving dashboard', size=(45,1))],
    [sg.Button('Save'), sg.Button('Exit')]]

    window=sg.Window('Save plot', layout=layout, size=(800,600))##figure out if we can make multiple file saves work or just go for single save and then returning to the original plot
...
if __name__=='__main__':
    ...
    from saving_utils import savepdf
